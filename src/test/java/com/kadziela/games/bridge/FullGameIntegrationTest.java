...
{
	private static final Logger logger = LogManager.getLogger(FullGameIntegrationTest.class);
	 ...
	 public void testCreateGameEndpoint() throws URISyntaxException, InterruptedException, ExecutionException, TimeoutException 
	 {
	    ...
	    stompSession.subscribe("/topic/room", new MapStompFrameHandler());
	 ...
	 private class MapStompFrameHandler implements StompFrameHandler 
	 {
        @Override
